...
CAMERA_DISTANCE_OVERRIDE = 2250       -- How far out should we allow the camera to go?  1134 is the default in Dota

MINIMAP_ICON_SIZE = 1                   -- What icon size should we use for our heroes?
MINIMAP_CREEP_ICON_SIZE = 0             -- What icon size should we use for creeps?
MINIMAP_RUNE_ICON_SIZE = 0              -- What icon size should we use for runes?

RUNE_SPAWN_TIME = -1                   -- How long in seconds should we wait between rune spawns?
...
CUSTOM_TEAM_PLAYER_COUNT[DOTA_TEAM_GOODGUYS] = 15
